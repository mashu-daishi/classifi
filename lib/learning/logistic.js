...
lr.prototype.train = function( data ) {
  ...
  function calcAccuracy ( samples, targets ) {
...
lr.prototype.optimize = function( data ) {
  ...
  for( let i = 0; i < data.iterations; i++ ) {
    ...
    if ( data.optimizer === 'sgd' ) {
      ...
      throw new Error( 'unrecognized optimizer:', data.optimizer, 'Error: ac2471e0-0852-46e4-9fe3-25c244236d57' );
    }
